...
def get_entities(seq, suffix=False):
        ...
        for i, chunk in enumerate(seq + ['O']):
            ...
            if end_of_chunk(prev_tag, tag, prev_type, type_):
                if prev_type == "LeftSpeaker" or prev_type == "RightSpeaker" or prev_type == "Unknown":
                    prev_type = "Quoat"
...
def accuracy_score(y_true, y_pred):
    ...
    nb_correct = sum(y_t==y_p for y_t, y_p in zip(y_true, y_pred) if y_t != ' O' and y_p != 'O')
    nb_true = len(y_true)-y_true.count("O")
